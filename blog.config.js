...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lmzwan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '后端开发 | 学习笔记', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lmzwan.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,后端,Java,学习笔记', // 网站关键词 英文逗号隔开
